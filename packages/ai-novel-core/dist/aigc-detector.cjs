...
__export(aigc_detector_exports, {
  ...
  getAigcDetectorConfigFromSettings: () => getAigcDetectorConfigFromSettings,
...
var requireBuiltin = (0, import_node_module.createRequire)(import_node_path2.default.join(process.cwd(), "ai-novel-factory-runtime.js"));
...
function readAigcSettingsEnv(rootDir) {
  ...
  try {
    const dbPath = import_node_path2.default.join(factoryRoot, ".ai-novel-factory", "factory.sqlite");
