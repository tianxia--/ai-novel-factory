...
var workflow_kernel_exports = {};
__export(workflow_kernel_exports, {
  FactoryWorkflowTraceRecorder: () => FactoryWorkflowTraceRecorder,
  WorkflowKernel: () => WorkflowKernel
});
module.exports = __toCommonJS(workflow_kernel_exports);
