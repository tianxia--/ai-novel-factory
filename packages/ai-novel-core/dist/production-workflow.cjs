...
var production_workflow_exports = {};
__export(production_workflow_exports, {
  ObservableProductionWorkflowRunner: () => ObservableProductionWorkflowRunner,
  createProductionWorkflowKernel: () => createProductionWorkflowKernel,
  executeProductionAdvanceThroughKernel: () => executeProductionAdvanceThroughKernel,
  listProductionWorkflowNodes: () => listProductionWorkflowNodes,
  resolveProductionWorkflowNode: () => resolveProductionWorkflowNode
});
module.exports = __toCommonJS(production_workflow_exports);
...
var ObservableProductionWorkflowRunner = class {
  ...
  async execute(context, externalRunId = (0, import_node_crypto2.randomUUID)()) {
...
async function executeProductionAdvanceThroughKernel(context, executeAdvance) {
  ...
  const externalRunId = context.externalRunId || (0, import_node_crypto2.randomUUID)();
