...
export function createLocalTextEmbedding(text: string, dimensions = LOCAL_EMBEDDING_DIMENSIONS) {
...
export async function backfillPendingMemoryEmbeddings(rootDir: string, options: { projectId?: string | null; limit?: number } = {}) {
